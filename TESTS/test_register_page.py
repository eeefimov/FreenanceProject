...
class TestRegisterPage:
    ...
    def test_register_page_already_registered_link(self, start_page, register_page):
    ...
    def test_register_email_field_validation(self, start_page, register_page, val, expected):
        start_page.start_page_redirect("register")
    ...
    def test_register_login_field_validation(self, start_page, register_page, value, expected):
        start_page.start_page_redirect("register")
    ...
    def test_register_password_field_validation(self, start_page, register_page, value, expected):
        start_page.start_page_redirect("register")
    ...
    def test_register_password_confirm(self, start_page, register_page, val, expected, validation):
        start_page.start_page_redirect("register")
    ...
    def test_register_check_exist_user(self, start_page, register_page, email, login, pwd):
        start_page.start_page_redirect("register")
